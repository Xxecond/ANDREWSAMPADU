...
export default function Front (){
  ...
  <Image 
   ...
   fill
    className="object-fill border-2 border-black rounded-4xl flex-shrink-0"
  />
  ...
  <dt className="font-light md:text-lg text-left ">i'm Andrews</dt>
      <dd className="text-blue-800 font-bold md:text-lg text-left ">a web developer.
        ...
        <button className=" max-[640px]:mt-2 mx-auto mr-25 mt-7 p-1 text-sm md:text-base font-medium block 
